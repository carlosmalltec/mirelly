            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  Observer(builder: (_) {
                    var _bt = controller.isFormEdit ? 'ATUALIZAR':'CADASTRAR ITEM';
                    return Container(
                      height: 40.0,
                      ...
                      child: RaisedButton(
                        ...
                        child: controller.loading
                            ...
                            : Text(controller.isFormEdit ? 'ATUALIZAR':'CADASTRAR ITEM',
                        ...
                        onPressed: (){
                          ...
                          controller.isFormEdit ? controller.editPressed() : controller.newPressed();
                        },
